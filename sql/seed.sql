...
insert into DLC (name, description, code, price) values ('GTA V Premium Online Edition', 'Grand Theft Auto V, Ontvang meer dan GTA $10.000.000 aan w, Start jouw criminele imperium, Ontvang een verzameling voertuigen, Inclusief krachtige wapens, Ontvang GTA $1.000.000 extra cash', 'GTAVPRE', 34.99, 2)

insert into DLC (name, description, code, price) values ('FINAL FANTASY XV EPISODE ARDYN','For the first time, players take control of the greatest foe of Noctis in this brand-new episode of FINAL FANTASY XV! Delve into the dark tale of scorned saviour Ardyn Lucis Caelum and unravel the secrets surrounding his mysterious past.', 'FF15NOC', 4,99, 3)
